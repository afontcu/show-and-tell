# Show&Tell popularity contest

A simple popularity contest app to prioritise Show&Tell sessions.

This project serves as a frontend for the [Idea Manager backend](https://bitbucket.org/calidae/idea_manager.backend).
